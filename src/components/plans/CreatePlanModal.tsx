...
import { X, Package, Save, Plus, Trash2, CheckCircle, Crown, Eye } from 'lucide-react'
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mb-3">
                    ...
                    />
                    <button type="button" onClick={addFeature} className="px-4 py-2 bg-purple-500 text-white rounded-lg">
